...
vc_map( array(
	...
	'params'                    => array(
		...
		array(
			...
			'admin_label' => true,
			'value'       => 'Using innovative technogy',
		...
		array(
			...
			'admin_label' => true,
			'value'       => 'Certified Dentist Doctors',
		...
		array(
			...
			'admin_label' => true,
			'value'       => 'Guarantee Success of Treatment',
...
vc_map( array(
	'name'                      => esc_html__('Dentalcare single section', 'dentalcare'),
	'base'                      => 'dentalcare_single_section',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display single section', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
									...
									array(
									   ...
									   'description' => esc_html__( 'The layout your page children being display', 'dentalcare' ),
									   'value'       => array(
										esc_html__('Advanced Technology', 'dentalcare')     => 'advance_technology',
										esc_html__('Appointment', 'dentalcare') => 'appointment',
										esc_html__('Open Hours', 'dentalcare') => 'open_hours'
									   )
									),
									array(
										'type'       => 'attach_image',
									...
									array(
										...
										'heading'     => esc_html__( 'Title', 'dentalcare' ),
										'param_name'  => 'title',
										'description' => esc_html__( 'Enter title text here.', 'dentalcare' ),
										'dependency' => array(
															'element' => 'layout', 
															'value' => array(
																			'advance_technology',
									...
									array(
										...
										'admin_label' => true,
										'value'       => 'Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos.',
										'dependency' => array(
															'element' => 'layout', 
															'value' => array(
																			'advance_technology',
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'Days', 'dentalcare' ),
										'param_name'  => 'monday_friday',
										'description' => esc_html__( 'Enter days here.', 'dentalcare' ),
										'dependency' => array(
															'element' => 'layout', 
															'value' => array('open_hours'),
														)
									),	
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'Timing', 'dentalcare' ),
										'param_name'  => 'timing',
										'description' => esc_html__( 'Enter timing here.', 'dentalcare' ),
										'dependency' => array(
															'element' => 'layout', 
															'value' => array('open_hours'),
														)
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'Saturday', 'dentalcare' ),
										'param_name'  => 'saturday',
										'description' => esc_html__( 'Enter timing here.', 'dentalcare' ),
										'dependency' => array(
															'element' => 'layout', 
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'Closed', 'dentalcare' ),
										'param_name'  => 'closed',
										'description' => esc_html__( 'Enter timing here.', 'dentalcare' ),
										'dependency' => array(
															'element' => 'layout', 
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'Sunday', 'dentalcare' ),
										'param_name'  => 'sunday',
										'description' => esc_html__( 'Enter timing here.', 'dentalcare' ),
										'dependency' => array(
															'element' => 'layout', 
...
/*dentalcare practice section.. */

vc_map( array(
	'name'                      => esc_html__('Dentalcare dental practice', 'dentalcare'),
	'base'                      => 'dentalcare_dental_practice',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display dental practice', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
									array(
										'type'        => 'textfield',
									...
									array(
										...
										'param_name'  => 'description',
										'admin_label' => true,
										'value'       => 'To have your lawn look its best, trust Landscaping & Garening, Inc. to get the job done right. We take a great deal of pride in the quality of our work. we understand what complete customer satisfaction means customer satisfaction.',
									),
									array(
										'type'       => 'attach_image',
										'heading'    => esc_html__( 'Image', 'dentalcare' ),
										'param_name' => 'image_home',
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'SubTitle', 'dentalcare' ),
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'SubTitle  Description', 'dentalcare' ),
										'param_name'  => 'subtitle_description',
										'description' => esc_html__( 'Enter title text here.', 'dentalcare' ),
									),
									array(
										'type'       => 'attach_image',
										'heading'    => esc_html__( 'Image', 'dentalcare' ),
										'param_name' => 'image_home_two',
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'SubTitle', 'dentalcare' ),
										'param_name'  => 'subtitle_two',
										'description' => esc_html__( 'Enter title text here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'SubTitle  Description', 'dentalcare' ),
										'param_name'  => 'subtitle_description_two',
										'description' => esc_html__( 'Enter title text here.', 'dentalcare' ),
									),
										array(
										'type'       => 'attach_image',
										'heading'    => esc_html__( 'Image', 'dentalcare' ),
										'param_name' => 'image_home_three',
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'SubTitle', 'dentalcare' ),
										'param_name'  => 'subtitle_three',
										'description' => esc_html__( 'Enter title text here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'SubTitle  Description', 'dentalcare' ),
										'param_name'  => 'subtitle_description_three',
										'description' => esc_html__( 'Enter title text here.', 'dentalcare' ),
									),
										array(
										'type'       => 'attach_image',
										'heading'    => esc_html__( 'Image', 'dentalcare' ),
										'param_name' => 'image_home_right',
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'Extra class name', 'dentalcare' ),
...
vc_map( array(
	'name'                      => esc_html__('Dentalcare section three', 'dentalcare'),
	'base'                      => 'dentalcare_section_three',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Displayn section three', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
vc_map( array(
	'name'                      => esc_html__('Get touch', 'dentalcare'),
	'base'                      => 'dentalcare_get_touch',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Displayn get touch', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
/* our clinic section */	
vc_map( array(
	'name'                      => esc_html__('Our clinic', 'dentalcare'),
	'base'                      => 'dentalcare_our_clinic',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display our clinic', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
											array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading One', 'dentalcare' ),
										'param_name'  => 'our_clinic',
										'description' => esc_html__( 'Enter Heading here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Description', 'dentalcare' ),
										'param_name'  => 'our_desc',
										'description' => esc_html__( 'Enter description here.', 'dentalcare' ),
									),
											array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading Two', 'dentalcare' ),
										'param_name'  => 'our_clinic_two',
										'description' => esc_html__( 'Enter Heading here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Description', 'dentalcare' ),
										'param_name'  => 'our_desc_two',
										'description' => esc_html__( 'Enter description here.', 'dentalcare' ),
									),
									array(
										'type'       => 'vc_link',
...
/* success story */	
vc_map( array(
	'name'                      => esc_html__('success story', 'dentalcare'),
	'base'                      => 'dentalcare_success_story',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display success story', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
/* Home three welcome to dentalcare */	
vc_map( array(
	'name'                      => esc_html__('welcome to dental care', 'dentalcare'),
	'base'                      => 'dentalcare_welcome_to_dental_care',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display welcome to dental care', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
								...
								array(
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading section', 'dentalcare' ),
										'param_name'  => 'welcome_heading_color',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Description two', 'dentalcare' ),
										'param_name'  => 'welcome_desc_two',
										'description' => esc_html__( 'Enter Description Here.', 'dentalcare' ),
									),
									array(
										'type'       => 'vc_link',
...
/* Home three dentalcare right section*/	
vc_map( array(
	'name'                      => esc_html__('dental care right section', 'dentalcare'),
	'base'                      => 'dentalcare_dental_care_right',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display dental care right section', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
								...
								array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading one', 'dentalcare' ),
										'param_name'  => 'welcome_heading_one',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading one section', 'dentalcare' ),
										'param_name'  => 'welcome_heading_one_section',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Description one', 'dentalcare' ),
										'param_name'  => 'welcome_desc_one',
										'description' => esc_html__( 'Enter Description Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading two', 'dentalcare' ),
										'param_name'  => 'welcome_heading_two',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading two section', 'dentalcare' ),
										'param_name'  => 'welcome_heading_two_section',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading three', 'dentalcare' ),
										'param_name'  => 'welcome_heading_three',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading three section', 'dentalcare' ),
										'param_name'  => 'welcome_heading_three_section',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Description three', 'dentalcare' ),
										'param_name'  => 'welcome_desc_three',
										'description' => esc_html__( 'Enter Description Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
...
/* Home three dentalcare offer services*/	
vc_map( array(
	'name'                      => esc_html__('dental offer services section', 'dentalcare'),
	'base'                      => 'dentalcare_offer_services',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display dental offer services section', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
/* Home three dentalcare special offer */	
vc_map( array(
	'name'                      => esc_html__('dental special offer section', 'dentalcare'),
	'base'                      => 'dentalcare_special_offer',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display special offer section', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
/* Home four welcome to dentalcare */	
vc_map( array(
	'name'                      => esc_html__('home four welcome to dental care', 'dentalcare'),
	'base'                      => 'dentalcare_home_four_welcome',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display home four welcome to dental care', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
/* Home four our clinical services */	
vc_map( array(
	'name'                      => esc_html__('home four our clinic image', 'dentalcare'),
	'base'                      => 'dentalcare_our_clinic_image_gallery',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display home four our clinic image', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
/* Home four our clinic strip*/	
vc_map( array(
	'name'                      => esc_html__('home four our clinic strip', 'dentalcare'),
	'base'                      => 'dentalcare_home_four_our_clinic_strip',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display home four our clinic strip', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
								...
								array(
									...
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( ' Heading section two', 'dentalcare' ),
										'param_name'  => 'welcome_heading_three',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
									array(
										'type'        => 'textfield',
										'heading'     => esc_html__( 'call', 'dentalcare' ),
										'param_name'  => 'welcome_call',
										'description' => esc_html__( 'Enter Heading Here.', 'dentalcare' ),
									),
										array(
										'type'       => 'vc_link',
...
/* Home five our clinic strip*/	
vc_map( array(
	'name'                      => esc_html__('home five our clinic ', 'dentalcare'),
	'base'                      => 'dentalcare_home_five_our_clinic',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display home five our clinic ', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
/* home 5 single section.. */

vc_map( array(
	'name'                      => esc_html__('Dentalcare home five single section', 'dentalcare'),
	'base'                      => 'dentalcare_home_five_single_section',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display home five single section', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
									...
									array(
									   ...
									   'description' => esc_html__( 'The layout your page children being display', 'dentalcare' ),
									   'value'       => array(
										esc_html__('Qualified Doctors', 'dentalcare')     => 'Qualified_Doctors',
										esc_html__('Quality Equipment', 'dentalcare') => 'Quality_Equipment',
										esc_html__('Friendly Staff', 'dentalcare') => 'Friendly_Staff',
										esc_html__('Advanced Dentistry', 'dentalcare') => 'Advanced_Dentistry',
									   )
									),
									array(
										'type'       => 'attach_image',
...
vc_map( array(
	'name'                      => esc_html__('Dentalcare home five welcome', 'dentalcare'),
	'base'                      => 'dentalcare_home_five_welcome',
	'category'                  => esc_html__('Dentalcare Elements', 'dentalcare'),
	'description'               => esc_html__('Display home five welcome', 'dentalcare'),
	'save_always' 				=> true,
	'params'                    => array(
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	...
	class WPBakeryShortCode_DENTALCARE_Single_Section extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_dental_practice extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_section_three extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_Get_Touch extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_our_clinic extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_success_story extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_welcome_to_dental_care extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_dental_care_right extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_offer_services extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_special_offer extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_home_four_welcome extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_our_clinic_image_gallery extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_home_four_our_clinic_strip extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_home_five_our_clinic extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_home_five_single_section extends WPBakeryShortCode {
	}
	class WPBakeryShortCode_DENTALCARE_home_five_welcome extends WPBakeryShortCode {
	}
}