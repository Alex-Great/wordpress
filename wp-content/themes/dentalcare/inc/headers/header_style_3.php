...
<?php $stickyclass = '';
			...
			<header class="tt-header index3header <?php echo esc_attr($stickyclass); ?>">
				...
				<?php	$logo = get_template_directory_uri() .'/assets/images/tmp/logo_default.png';
						if (isset( $dentalcare_option['logo_header_three']['url'] )):	?>
							<a class="logo deskLogo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
								<img src="<?php echo esc_url( $dentalcare_option['logo_header_three']['url'] ); ?>"  alt="<?php bloginfo( 'name' ); ?>" />
							</a>
				<?php 	elseif( $logo ) : ?>
							<a class="logo deskLogo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
				...
				<?php	endif; 
						...
						if (isset( $dentalcare_option['mobile_logo_two']['url'] )):	?>
							<a class="logo mobLogo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
								<img src="<?php echo esc_url( $dentalcare_option['mobile_logo_two']['url'] ); ?>"  alt="<?php bloginfo( 'name' ); ?>" />
							</a>
				<?php 	elseif( $logo ) : ?>
							<a class="logo mobLogo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
								<img src="<?php echo esc_url( $logo ); ?>"  alt="<?php bloginfo( 'name' ); ?>" />
